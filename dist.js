...
(function(){
  var jsonpatch, extend;
  jsonpatch = require('fast-json-patch');
  extend = require('extend');
  module.exports = function(id, observes){
    var state, clone, changed;
    state = {
      backup: {},
      current: {}
    };
    clone = function(){
      return state.backup = extend({}, state.current);
    };
    changed = function(){
      observes.forEach(function(observer){
        return observer({
          patch: jsonpatch.compare(state.backup, state.current),
          obj: state.current,
          id: id
        });
      });
    ...
    Object.observe(state.current, changed);
    return state.current;
  };
}).call(this);

},{"extend":2,"fast-json-patch":3}],2:[function(require,module,exports){
'use strict';
